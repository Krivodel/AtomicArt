...
public sealed class AtomicArtPicaActions
{
    ...
    public PicaActionDefinition Imba => new(
        ...
        GalleryIconGeometry.Imba,
        ImbaIconRotationDegrees,
    ...
    private const double ImbaIconRotationDegrees = 0d;
    private const int ImbaOrder = 101;
    private const double OpenDlss5IconRotationDegrees = 0d;
