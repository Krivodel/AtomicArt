...
public sealed class MotionEasingTests
{
    public static TheoryData<Func<double, double>, double, double> ReferenceSamples =>
        new TheoryData<Func<double, double>, double, double>
        {
            ...
            { MotionEasing.EaseOutCirc, 0d, 0d },
            { MotionEasing.EaseOutCirc, 0.25d, 0.66143782776614768d },
            { MotionEasing.EaseOutCirc, 0.5d, 0.8660254037844386d },
            { MotionEasing.EaseOutCirc, 0.75d, 0.96824583655185426d },
            { MotionEasing.EaseOutCirc, 1d, 1d },
