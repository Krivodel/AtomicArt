...
internal sealed class PreviousGoogleStreamingResponseAnalyzer
{
    ...
    public PreviousGoogleStreamingResponseAnalyzer(
    ...
    public ProviderGenerationSummary Complete()
    {
            ...
            or AnalyzerState.AfterDataKey)
        {
            throw new InvalidOperationException(
                "The benchmark response must contain complete JSON.");
        }
        ...
        {
            throw new InvalidOperationException(
                "The benchmark response must be successful.");
        }

        GoogleInteractionsResult result = _responseParser.Parse(filteredJson);
    ...
    private static void ThrowIfDiagnosticTextExceedsLimit(JsonElement element)
    {
